...
function Footer() {
  return(
     <>
     <div className="main-footer fixed-bottom" style = {{display:"flex",justifyContent:'center', justifyItems:'center',alignItems:'center', backgroundColor:'black', color:'white', fontweight:'bold', padding:'25px'}}>
